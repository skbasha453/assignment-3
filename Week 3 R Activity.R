...
getwd()
setwd("C:/users/Sowm/Documents/Assignments")
...
height_o <- women_data$height
weight_o <- women_data$weight
...
new_women_data <- data.frame(height = height_o, weight=weight_o)
...
ggplot(women_data, aes(x=height, y=weight)) + 
  geom_point(shape = 18, colour = "brown", fill = "red", size = 5, stroke = 5)
